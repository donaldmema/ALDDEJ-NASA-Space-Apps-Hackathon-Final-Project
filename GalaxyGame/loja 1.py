...
pygame.display.set_caption('Space Seekers')
...
#background
sky_img = pygame.image.load('img/Background/galaxy5.jpg').convert_alpha()
...
class Soldier(pygame.sprite.Sprite):
	...
	def move(self, moving_left, moving_right):
		...
		#check for collision with water
		if pygame.sprite.spritecollide(self, barrier_group, False):
			...
			for x, tile in enumerate(row):
				if tile >= 0:
					...
					if tile >= 0 and tile <= 8:
						...
						barrier = Barrier(img, x * TILE_SIZE, y * TILE_SIZE, 1.65, 5)
